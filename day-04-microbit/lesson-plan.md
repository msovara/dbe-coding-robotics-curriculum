...
**Prerequisites:** Days 1-3 completion (Scratch and Arduino experience)

**Learning Objectives:**
- Introduce the Micro:bit platform and its role in coding and robotics
- Use the MakeCode editor (block-based and/or text)
- Program inputs (buttons, sensors) and outputs (LED grid, pins)
- Create simple Micro:bit projects suitable for the classroom
