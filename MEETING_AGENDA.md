# DBE Coding and Robotics Curriculum – Meeting Agenda

**Meeting focus:** Curriculum overview, 5-day workshop structure, and next steps  
**Suggested duration:** 60–90 minutes  
**Repository:** [github.com/msovara/dbe-coding-robotics-curriculum](https://github.com/msovara/dbe-coding-robotics-curriculum)
...
- **Integration:** Aligned with CHPC Training DSI Coding School ([CHPC_INTEGRATION.md](CHPC_INTEGRATION.md))
...
- **Structure:** One folder per day (`day-01-scratch` … `day-05-microbit-codeclub`) plus `resources/` and `supporting-materials/`
- **Key documents:**
  - [README.md](README.md) – Overview and directory structure
  - [WORKSHOP_TIMETABLE.md](WORKSHOP_TIMETABLE.md) – Full daily timetable
  - [WORKSHOP_TIMETABLE_ONE_PAGE.md](WORKSHOP_TIMETABLE_ONE_PAGE.md) – One-page summary
  - [CURRICULUM-SUMMARY.md](CURRICULUM-SUMMARY.md) – Full curriculum summary
  - [resources/procurement-guide.md](resources/procurement-guide.md) – Hardware/software requirements
  - [resources/templates/integration-planning-template.md](resources/templates/integration-planning-template.md) – Integration/action planning

- **Supporting materials:** Pre-workshop survey, daily reflection template, evaluation form (in `supporting-materials/`)
...
## Handy links for the meeting

- **Repo:** https://github.com/msovara/dbe-coding-robotics-curriculum  
- **CHPC integration:** [CHPC_INTEGRATION.md](CHPC_INTEGRATION.md)  
- **One-page timetable:** [WORKSHOP_TIMETABLE_ONE_PAGE.md](WORKSHOP_TIMETABLE_ONE_PAGE.md)  
- **Email templates (invites/summaries):** [EMAIL_TEMPLATE.md](EMAIL_TEMPLATE.md), [EMAIL_WORKSHOP_SUMMARY.md](EMAIL_WORKSHOP_SUMMARY.md)
